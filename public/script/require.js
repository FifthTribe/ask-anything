...
(function (ha) {
  ...
  function ma(b) {
    ...
    function p(a) {
      var n = g(m.paths, a);
      if (n && M(n) && 1 < n.length) return n.shift(), h.require.undef(a), h.makeRequire(null, {
        skipMap: !0
      })([a]), !0
    }

    function e(a) {
      var n, b = a ? a.indexOf("!") : -1; - 1 < b && (n = a.substring(0, b), a = a.substring(b + 1, a.length));
      return [n, a]
    }
    ...
    function I() {
      var a, b, c = (a = 1E3 * m.waitSeconds) && h.startTime + a < (new Date).getTime(),
        f = [],
        l = [],
        k = !1,
        g = !0;
    ...
    ea.prototype = {
      init: function (a, b, c, f) {
        ...
        if (!this.inited) {
          ...
          else this.events.error && (c = y(this, function (a) {
            this.emit("error",
              a)
          }));
        ...
        Z(e, {
          ...
          toUrl: function (b) {
            var d, e = b.lastIndexOf("."),
              n = b.split("/")[0]; - 1 !== e && ("." !== n && ".." !== n || 1 < e) && (d = b.substring(e, b.length), b = b.substring(0, e));
